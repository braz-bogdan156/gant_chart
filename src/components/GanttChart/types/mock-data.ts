...
export const tasks: Task[] = [
  { id: 1, name: 'Task 1', estimateHours: 51.961, actualHours: 83.527, estimateStartDate: new Date('2024-01-01'), estimateEndDate: new Date('2024-01-10'), actualStartDate: new Date('2024-01-02'), actualEndDate: new Date('2024-01-12') },
  { id: 1.1, name: 'Subtask 1.1', estimateHours: 45.407, actualHours: 30.208, estimateStartDate: new Date('2024-01-05'), estimateEndDate: new Date('2024-01-15'), actualStartDate: new Date('2024-01-06'), actualEndDate: new Date('2024-01-16') },
